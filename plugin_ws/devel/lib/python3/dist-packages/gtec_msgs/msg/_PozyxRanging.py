...
"""autogenerated by genpy from gtec_msgs/PozyxRanging.msg. Do not edit."""
import codecs
import sys
...
class PozyxRanging(genpy.Message):
  _md5sum = "2b846533027dd07c0ff5d2424addc37b"
  _type = "gtec_msgs/PozyxRanging"
...
float64 txGain
float64 angle"""
  __slots__ = ['originId','originType','destinationId','destinationType','range','ts','seq','rxPower','channel','datarate','prf','preambleLength','txGain','angle']
  _slot_types = ['int32','int16','int32','int16','int32','int32','int32','float64','float64','float64','int32','int32','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       originId,originType,destinationId,destinationType,range,ts,seq,rxPower,channel,datarate,prf,preambleLength,txGain,angle
    ...
    """
    if args or kwds:
      super(PozyxRanging, self).__init__(*args, **kwds)

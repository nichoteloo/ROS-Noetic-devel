// Generated by gencpp from file gtec_msgs/UWBRanging.msg
// DO NOT EDIT!


#ifndef GTEC_MSGS_MESSAGE_UWBRANGING_H
#define GTEC_MSGS_MESSAGE_UWBRANGING_H
...
struct UWBRanging_
{
  typedef UWBRanging_<ContainerAllocator> Type;
  ...
  UWBRanging_(const ContainerAllocator& _alloc)
    : anchorId(0)
    , tagId(0)
    , range(0)
    , rawrange(0)
  ...
  _rawrange_type rawrange;
   ...
   typedef int32_t _biasCorrection_type;
  _biasCorrection_type biasCorrection;
  ...
  typedef boost::shared_ptr< ::gtec_msgs::UWBRanging_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gtec_msgs::UWBRanging_<ContainerAllocator> const> ConstPtr;

}; // struct UWBRanging_

typedef ::gtec_msgs::UWBRanging_<std::allocator<void> > UWBRanging;

typedef boost::shared_ptr< ::gtec_msgs::UWBRanging > UWBRangingPtr;
typedef boost::shared_ptr< ::gtec_msgs::UWBRanging const> UWBRangingConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gtec_msgs::UWBRanging_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gtec_msgs::UWBRanging_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gtec_msgs::UWBRanging_<ContainerAllocator1> & lhs, const ::gtec_msgs::UWBRanging_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::gtec_msgs::UWBRanging_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gtec_msgs::UWBRanging_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gtec_msgs::UWBRanging_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gtec_msgs::UWBRanging_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gtec_msgs::UWBRanging_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gtec_msgs::UWBRanging_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gtec_msgs::UWBRanging_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gtec_msgs::UWBRanging_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa2ecb2ec6e49b585ULL;
  static const uint64_t static_value2 = 0x6c7d150d936a536bULL;
};

template<class ContainerAllocator>
struct DataType< ::gtec_msgs::UWBRanging_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gtec_msgs::UWBRanging_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gtec_msgs::UWBRanging_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gtec_msgs::UWBRanging_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gtec_msgs::UWBRanging_<ContainerAllocator>& v)
  {
    s << indent << "anchorId: ";
    ...
    s << indent << "biasCorrection: ";
    Printer<int32_t>::stream(s, indent + "  ", v.biasCorrection);
    s << indent << "seq: ";
...
#endif // GTEC_MSGS_MESSAGE_UWBRANGING_H
